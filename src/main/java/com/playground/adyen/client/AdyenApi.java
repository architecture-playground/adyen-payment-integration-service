...
public interface AdyenApi {
    ...
    /**
     * @see <a href="https://docs.adyen.com/api-explorer/#/PaymentSetupAndVerificationService/v52/payments">POST /payments</a>
     */
    @PostMapping(
            path = "/payments",
            consumes = MediaType.APPLICATION_JSON_VALUE,
    ...
    AdyenPaymentResponseDTO sendPayment(AdyenPaymentsRequestDTO request);
    ...
    AdyenPaymentResponseDTO sendPaymentDetails(AdyenPaymentDetailsRequestDTO request);
}
